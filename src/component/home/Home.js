      ...
      <div className="section">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <div className="section-title">
                <h3 className="title">Chó</h3>
                <div className="section-nav">
                  <ul className="section-tab-nav tab-nav">
                    <li className="active"><a data-toggle="tab" href="#tab1"> Corgi</a></li>
                    <li><a data-toggle="tab" href="#tab1"> Poodle</a></li>
                    <li><a data-toggle="tab" href="#tab2"> Husky</a></li>
                    <li><a data-toggle="tab" href="#tab1"> Shiba</a></li>
                  </ul>
                </div>
              </div>
            </div>
